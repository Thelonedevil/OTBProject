...
- [Account](#account)
	- [Path](#path)
	- [Sample Account Configuration File](#sample-account-configuration-file)
	- [Fields](#fields)
- [General Config](#general-config)
 	- [Path](#path-1)
	- [Sample General Configuration File](#sample-general-configuration-file)
	- [Fields](#fields-1)
- [Bot Config](#bot-config)
	- [Path](#path-2)
	- [Sample Bot Configuration File](#sample-bot-configuration-file)
	- [Fields](#fields-2)
- [Channel Config](#channel-config)
	- [Path](#path-3)
	- [Sample Channel Configuration File](#sample-channel-configuration-file)
	- [Fields](#fields-3)
